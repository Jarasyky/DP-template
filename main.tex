...
\newcommand{\logoSkola}{\includegraphics[scale=1.5]{logo.pdf}}  % logo
...
\noindent\begin{tabularx}{\textwidth}{| Y | C{4.5cm} | C{4.5cm} |}
	...
	\Z \Nad{Druh práce} & \sout{\Nad{Diplomová}} & \Nad{Bakalářská} \\ \hline 
...
\noindent\begin{tabularx}{\textwidth}{| Y | C{4.5cm} | C{4.5cm} |}
	...
	\Z \Nad{Type of work} & \sout{\Nad{Diploma}} & \Nad{Bachelor} \\ \hline 
